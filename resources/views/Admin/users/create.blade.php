                            ...
                            <form class="form" action="{{route('admin.users.store')}}" method="post">
                                ...
                                <div class="form-body">
                                    ...
                                    <h4 class="form-section">
                                        <i class="ft-briefcase"></i> اطلاعات کاربر</h4>
                                    <div class="form-group">
                                        <label for="contactinput5">نام</label>
                                        <input class="form-control border-primary" name="name" type="text" placeholder="نام" id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5">پست الکترونیک</label>
                                        <input class="form-control border-primary" name="email" type="email" placeholder="پست الکترونیک" id="contactemail5">
                                    </div>
