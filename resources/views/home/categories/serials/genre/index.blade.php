                    ...
                    <div class="row row--grid">
                        @foreach($genres as $genre)
                            <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                                <div class="card">
                                    <a href="{{route('single_serial',$genre->title)}}" class="card__cover">
                                    ...
                                    <form action="{{route('interest-serial')}}" method="post">
                                        ...
                                        <input type="hidden" value="{{$genre->id}}" name="interestable_id">
                                    ...
                                    <h3 class="card__title"><a href="{{route('single_serial',$genre->title)}}">  {{$genre->title}}</a></h3>
                                </div>
                            </div>
                        @endforeach
