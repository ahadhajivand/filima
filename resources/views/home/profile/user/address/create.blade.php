                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="content-section default">
                            ...
                            <form class="form-account" action="{{route('profile.address.store')}}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="form-account-row">
                                            <input class="input-field text-right" type="text" name="title" placeholder="عنوان آدرس خود را وارد نمایید">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="form-account-row">
                                            <select name="city_id" class="form-control" aria-label="Default select example">
                                                <option class="selected">شهر خود را انتخاب کنید</option>
                                                    @foreach($cities as $city)
                                                        <option value="{{$city->id}}" {{$city->state_id}}>{{$city->title}}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="form-account-row">
                                            <input class="input-field text-right" type="text" name="address" placeholder="آدرس  خود را وارد نمایید">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-account-title">شماره همراه</div>
                                        <div class="form-account-row">
                                            <input class="input-field" type="text" name="phone" placeholder=" شماره همراه خود را وارد نمایید" >
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-account-title">کد پستی</div>
                                        <div class="form-account-row">
                                            <input class="input-field" type="text" name="postal_code" placeholder=" کد پستی  خود را وارد نمایید">
                                        </div>
                                    </div>
                                </div>
