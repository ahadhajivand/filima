            ...
            <div class="col-md-12">
                <div class="card" style="height: 800px;">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-colored-form-control">فرم ورود اطلاعات دسترسی</h4>
                            ...
                            <form class="form" action="{{route('admin.permissions.store')}}" method="post">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="title" type="text" placeholder="نام" id="contactinput5">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="description" type="text" placeholder="توضیحات" id="contactinput5">
                                    </div>
