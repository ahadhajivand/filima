@component('Admin.layouts.content',['title' => 'ایجاد فیلم'])
    @slot('breadcrumb')
            ...
            <div class="col-md-12">
                <div class="card" style="height: 1900px;">
                    <div class="card-header">
                        ...
                        <h4 class="card-title" id="basic-layout-colored-form-control">فرم ورود اطلاعات فیلم</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{route('admin.films.store')}}" method="post">
                               @csrf
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="title" type="text" placeholder="نام  فیلم" id="contactinput5">
                                    </div>


                                    <div class="form-group">
                                        <label for="contactinput5">  پوستر فیلم </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="year" type="text" placeholder="سال ساخت" id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5"> زمان فیلم  مثال : 43 دقیقه</label>
                                        <input class="form-control border-primary" name="time" type="text" placeholder="زمان فیلم" id="contactinput5">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="link_download_one" type="text" placeholder="لینک دانلود فیلم" id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5">لینک دانلود فیلم کیفیت(720p) </label>
                                        <input class="form-control border-primary" name="link_download_two" type="text" placeholder=" لینک دانلود فیلم " id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5">لینک دانلود فیلم کیفیت(480p) </label>
                                        <input class="form-control border-primary" name="link_download_three" type="text" placeholder="  لینک دانلود فیلم " id="contactinput5">
                                    </div>


                                    <div class="form-group">
                                        <label for="contactinput5">ژانر اول فیلم </label>
                                        <input class="form-control border-primary" name="genre_one" type="text" placeholder="  ژانر  فیلم " id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5">ژانر دوم فیلم </label>
                                        <input class="form-control border-primary" name="genre_two" type="text" placeholder="  ژانر  فیلم " id="contactinput5">
                                    </div>


                                    <div class="form-group">
                                        <label for="contactinput5">ژانر سوم فیلم </label>
                                        <input class="form-control border-primary" name="genre_three" type="text" placeholder="  ژانر  فیلم " id="contactinput5">
                                    </div>

                                    <input class="form-control border-primary" name="category" type="hidden" value="1" id="contactinput5">
