        ...
        <div class="row">
            <div class="profile-page col-xl-9 col-lg-8 col-md-12 order-2">
                <div class="row">
                    <div class="col-12">
                        <div class="col-12">
                            <h1 class="title-tab-content">ویرایش اطلاعات آدرس</h1>
                        </div>
                        <div class="content-section default">
                            ...
                            <form class="form-account" action="{{route('profile.address.update' , $address->id)}}" method="post">
                                @csrf
                                @method('patch')
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="form-account-row">
                                            <input class="input-field text-right" type="text" name="title" placeholder="عنوان آدرس خود را وارد نمایید" value="{{old('title' , $address->title)}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="form-account-row">
                                            <input class="input-field text-right" type="text" name="address" placeholder="آدرس  خود را وارد نمایید" value="{{old('title' , $address->address)}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-account-title">شماره همراه</div>
                                        <div class="form-account-row">
                                            <input class="input-field" type="text" name="phone" placeholder=" شماره همراه خود را وارد نمایید" value="{{old('title' , $address->phone)}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-account-title">کد پستی</div>
                                        <div class="form-account-row">
                                            <input class="input-field" type="text" name="postal_code" placeholder=" کد پستی  خود را وارد نمایید" value="{{old('title' , $address->postal_code)}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 text-center">
                                    ...
                                    <a href="{{route('profile.address.index')}}" class="btn btn-default btn-lg">انصراف</a>
                                </div>
                            </form>
                        </div>
                    </div>
