@component('Admin.layouts.content',['title' => 'ایجاد پلن ااشتراک'])
    @slot('breadcrumb')
        <li class="breadcrumb-item active">ایجاد پلن اشتراک </li>
        <li class="breadcrumb-item"><a href="{{route('admin.')}}">خانه</a></li>
        <li class="breadcrumb-item"><a href="{{route('admin.plans.index')}}" class="btn btn-sm btn-warning">لیست پلن ها</a></li>
    @endslot
            ...
            <div class="col-md-12">
                <div class="card" style="height: 1750px;">
                    <div class="card-header">
                        ...
                        <h4 class="card-title" id="basic-layout-colored-form-control">فرم ورود اطلاعات پلن</h4>
                               ...
                               @csrf
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="title" type="text" placeholder="نام پلن" id="contactinput5">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="price" type="text" placeholder="قیمت پلن" id="contactinput5">
                                    </div>
